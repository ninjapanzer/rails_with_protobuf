...
# source://erubis//lib/erubis/tiny.rb#6
module Erubis; end
...
# source://erubis//lib/erubis/tiny.rb#74
...
# source://erubis//lib/erubis/tiny.rb#77
class Erubis::PI::TinyEruby
  # @return [TinyEruby] a new instance of TinyEruby
  #
  # source://erubis//lib/erubis/tiny.rb#79
  def initialize(input = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://erubis//lib/erubis/tiny.rb#88
  def convert(input); end

  # source://erubis//lib/erubis/tiny.rb#132
  ...
  # end
  #
  # source://erubis//lib/erubis/tiny.rb#128
  def result(_binding = T.unsafe(nil)); end

  # Returns the value of attribute src.
  #
  # source://erubis//lib/erubis/tiny.rb#84
  def src; end
end

# source://erubis//lib/erubis/tiny.rb#86
...
#
# source://erubis//lib/erubis/tiny.rb#17
class Erubis::TinyEruby
  # @return [TinyEruby] a new instance of TinyEruby
  #
  # source://erubis//lib/erubis/tiny.rb#19
  def initialize(input = T.unsafe(nil)); end

  # source://erubis//lib/erubis/tiny.rb#26
  def convert(input); end

  # source://erubis//lib/erubis/tiny.rb#61
  def evaluate(_context = T.unsafe(nil)); end
  ...
  # end
  #
  # source://erubis//lib/erubis/tiny.rb#57
  def result(_binding = T.unsafe(nil)); end

  # Returns the value of attribute src.
  #
  # source://erubis//lib/erubis/tiny.rb#22
  def src; end
end

# source://erubis//lib/erubis/tiny.rb#24
