...
#
# source://tilt//lib/tilt/erubis.rb#17
class Tilt::ErubisTemplate < ::Tilt::ERBTemplate
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/erubis.rb#42
  def freeze_string_literals?; end

  # Erubis doesn't have ERB's line-off-by-one under 1.9 problem.
  # Override and adjust back.
  #
  # source://tilt//lib/tilt/erubis.rb#37
  def precompiled(locals); end

  # source://tilt//lib/tilt/erubis.rb#31
  def precompiled_postamble(locals); end

  # source://tilt//lib/tilt/erubis.rb#27
  def precompiled_preamble(locals); end
...
# source://tilt//lib/tilt/haml.rb#11
class Tilt::HamlTemplate < ::Tilt::Template
  # @raise [ArgumentError]
  #
  # source://tilt//lib/tilt/haml.rb#26
  def evaluate(scope, locals, &block); end
  ...
  #
  # source://tilt//lib/tilt/haml.rb#31
  def precompiled_template(locals); end

  # Following definitions are for Haml <= 4 and deprecated.
  #
  # source://tilt//lib/tilt/haml.rb#16
  def prepare; end
end
